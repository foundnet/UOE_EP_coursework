...
task=task2
filename=../Result/task1/composed/output.txt
...
hadoop jar $STREAM -mapper mapper.py -combiner combiner.py -reducer reducer.py -input $RPATH/input/$task -output $RPATH/output/$task -file mapper.py -file reducer.py -file combiner.py -numReduceTasks 9
