...
task=task1
filename=/data/assignments/ex1/webLarge.txt
...
hadoop jar $STREAM -mapper mapper.py -reducer "cat" -input $RPATH/input/$task -output $RPATH/output/$task -file mapper.py
