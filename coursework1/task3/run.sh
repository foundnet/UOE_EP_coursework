...
hadoop jar $STREAM -mapper mapper.py -combiner reducer.py -reducer reducer.py -input $RPATH/input/$task -output $RPATH/output/$task -file mapper.py -file reducer.py -numReduceTasks 1
